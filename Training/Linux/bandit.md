# BANDIT LABS
## Terminal
   1.First you can start the terminal you will see the starting stage of terminal then you need to go that terminal you can access that terminal by " sudo su " 
...
Step-3: (Opening in nano to edit, Rename it and save it (sshkey)) In another terminal. Then Set correct permissions on the key
